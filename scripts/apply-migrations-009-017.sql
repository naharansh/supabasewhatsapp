...
--   4. Click "Run"
--
-- Fixes "messages not stored in the database" issue:
--   - Adds reply_to_message_id (mig 009)
--   - Adds interactive_reply_id + widens content_type CHECK (mig 010)
--   - Creates message_reactions table (mig 009)
--   - Creates users, flows, galleries, subscriptions tables
-- ============================================================
